...
export function GET() {
  const lines = [
    ...
    '- Dataset manifest, publishing crosswalk, and research graph semantics are consolidated into /graph-ghezelbaash-final.jsonld.',
    '- The primary graph is the only standalone public JSON-LD endpoint.',
    '',
    'Dataset policy:',
