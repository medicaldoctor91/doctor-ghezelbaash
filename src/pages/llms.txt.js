...
export function GET() {
  const lines = [
    ...
    '- Dataset manifest and publishing crosswalk semantics are consolidated into /graph-ghezelbaash-final.jsonld.',
    '- The only standalone JSON-LD projections are the primary graph and the focused research graph.',
    '',
    'Dataset policy:',
