...
export function GET() {
  const lines = [
    ...
    `Content briefs: ${absoluteUrl('/content-briefs.json')}`,
    '',
    ...
    '',
    'Content policy:',
    '- /content-briefs.json describes required page-copy structure for later copy generation.',
    '- It is not final published prose; it is a machine-readable production brief.',
    '',
    'Dataset policy:',
