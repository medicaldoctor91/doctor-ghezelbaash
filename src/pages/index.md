...
<h2 id="dr-saeed-ghezelbash-aesthetic-clinic-kermanshah"><a href="/graph.jsonld" type="application/ld+json">کلینیک زیبایی دکتر سعید قزلباش در کرمانشاه؛ معاینه، درمان، اصلاح و پیگیری مستقیم</a></h2>
...
<h3 id="saeed-ghezelbash-clinic-contact-and-location"><a href="https://www.instagram.com/doctor.ghezelbaash/" rel="me external">آدرس و تماس رسمی کلینیک زیبایی دکتر سعید قزلباش در کرمانشاه</a></h3>
...
<p>
The project publishes canonical entity identifiers, public clinic information, service taxonomy, linked-source relationships and reusable JSON and JSON-LD files. The current live knowledge graph is version 1.2.1; version 1.0.0 remains the archived DOI release. The
...
<dt><strong>Current live graph version</strong></dt>
