export const externalProfiles = {
  ...
  observedButNeedsDirectVerification: [
    ...
    { platform: 'X', url: 'https://twitter.com/Qezelbaash' },
    { platform: 'Facebook', source: 'Linktree social list' },
    { platform: 'TikTok', source: 'Linktree social list' },
    { platform: 'Threads', source: 'Linktree social list' },
    { platform: 'Pinterest', source: 'Linktree social list' },
