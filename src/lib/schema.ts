...
export function buildSchemaParts(headings: MarkdownHeading[], raw: string) {
  ...
  const externalProfileNodes: JsonNode[] = site.externalProfiles.map((profile) => ({
    ...
    url: profile.url,
    name: profile.name,
    about: profile.id === 'instagram'
      ? [{ '@id': ids.clinic }, { '@id': ids.person }]
      : { '@id': ids.person },
    ...(profile.id === 'instagram' ? { mainEntity: { '@id': ids.clinic } } : {}),
  ...
  const authorityAssetNodes: JsonNode[] = [
    ...
    {
      '@type': 'WebPage',
      '@id': site.doctorGoogleKnowledgeGraphUrl,
      url: site.doctorGoogleKnowledgeGraphUrl,
      name: `Google Knowledge Graph MID ${site.doctorGoogleKnowledgeGraphId} برای دکتر سعید قزلباش`,
      about: { '@id': ids.person },
    ...
    {
      '@type': 'WebPage',
      '@id': site.clinicGoogleLocalKnowledgeGraphUrl,
      url: site.clinicGoogleLocalKnowledgeGraphUrl,
      name: `Google Local Knowledge Graph MID ${site.clinicGoogleLocalKnowledgeGraphId} برای کلینیک دکتر سعید قزلباش`,
      about: { '@id': ids.clinic },
  ...
  const personNode: JsonNode = {
    ...
    identifier: [
      ...
      { '@type': 'PropertyValue', propertyID: 'GoogleKnowledgeGraphMID', value: site.doctorGoogleKnowledgeGraphId, url: site.doctorGoogleKnowledgeGraphUrl },
      { '@type': 'PropertyValue', propertyID: 'GoogleCloudEnterpriseKnowledgeGraphMID', value: site.doctorCloudKnowledgeGraphMid },
    ],
    hasCredential: { '@id': ids.credential },
    memberOf: { '@id': ids.irimcOrganization },
    sameAs: unique([site.irimcVerification, site.orcidUrl, site.doctorWikidata, site.huggingFaceProfile, site.githubProfile, site.linkedinProfile, site.aboutMeProfile, site.linktreeProfile, site.xProfile]),
  ...
  const clinicNode: JsonNode = {
    ...
    alternateName: ['کلینیک دکتر قزلباش', 'کلینیک زیبایی قزلباش', site.instagramHandle],
    url: site.url,
    logo: { '@id': ids.logo },
    telephone: site.phone,
    ...
    identifier: [
      ...
      { '@type': 'PropertyValue', propertyID: 'GoogleLocalKnowledgeGraphMID', value: site.clinicGoogleLocalKnowledgeGraphId, url: site.clinicGoogleLocalKnowledgeGraphUrl },
    ...
    subjectOf: [{ '@id': site.instagram }, { '@id': ids.reputationSnapshot }, { '@id': ids.authorityNetwork }, { '@id': ids.editorialReview }],
    potentialAction: [
