...
const excludedExact=new Set(['src/content/home.md','src/data/semantic/head-graph.json','src/data/semantic/support-graph.json','src/data/semantic/knowledge-graph.ttl','src/data/semantic/rdf-lock.json','public/doctor.vcf','public/clinic.vcf']);
