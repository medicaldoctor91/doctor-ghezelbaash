...
await replaceOnce(
  ...
  "/media/images/physician/saeed-ghezelbash-portrait-delivery-640.f41e5aa1c0dd.avif 640w, /media/images/physician/saeed-ghezelbash-portrait-960.abde9c5ed375.avif 960w",
  `/media/images/physician/saeed-ghezelbash-portrait-delivery-640.f41e5aa1c0dd.avif 640w, /media/images/physician/${avif} 768w, /media/images/physician/saeed-ghezelbash-portrait-960.abde9c5ed375.avif 960w`,
);
await replaceOnce(
  "src/content-source/page.md",
  "/media/images/physician/saeed-ghezelbash-portrait-delivery-640.5c350c081420.webp 640w, /media/images/physician/saeed-ghezelbash-portrait-960.637a6fbe30a3.webp 960w",
  `/media/images/physician/saeed-ghezelbash-portrait-delivery-640.5c350c081420.webp 640w, /media/images/physician/${webp} 768w, /media/images/physician/saeed-ghezelbash-portrait-960.637a6fbe30a3.webp 960w`,
);
await replaceOnce(
...
await replaceOnce(
  ...
  "public/media/images/physician/saeed-ghezelbash-portrait-960.avif|960|640\n",
  "public/media/images/physician/saeed-ghezelbash-portrait-768.avif|768|512\npublic/media/images/physician/saeed-ghezelbash-portrait-768.webp|768|512\npublic/media/images/physician/saeed-ghezelbash-portrait-960.avif|960|640\n",
);

const candidateBytes = (await stat(`public/media/images/physician/${avif}`)).size;
const baselineBytes = (await stat("public/media/images/physician/saeed-ghezelbash-portrait-960.abde9c5ed375.avif")).size;
