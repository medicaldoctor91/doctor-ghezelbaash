...
const required=[
  ...
  'scripts/clean-generated-workspace.mjs','scripts/lib/generated-workspace.mjs','scripts/materialize-static-artifacts.mjs',
...
for(const removed of ['scripts/promote-generated-workspace.mjs','src/data/page-metadata.json','src/data/templates/main-head.html','src/data/templates/discovery-head.html','src/data/templates/footer.html','src/data/templates/quick-actions.html','src/lib/head-delivery.mjs','src/lib/static-endpoint.ts'])assert(!(await exists(removed)),`Legacy architecture residue exists: ${removed}`);
...
const files=await Promise.all([
  ...
  read('scripts/lib/projection-context.mjs'),read('scripts/lib/generated-workspace.mjs'),read('scripts/lib/projections/page-assets.mjs'),read('scripts/lib/projections/graph-projections.mjs'),read('scripts/lib/projections/retrieval-corpus.mjs'),read('scripts/lib/projections/contact-discovery.mjs'),
  ...
  read('src/components/DocumentHead.astro'),read('src/layouts/BaseLayout.astro'),read('src/pages/index.astro'),read('src/components/SiteFooter.astro'),read('src/components/FloatingActionDock.astro'),read('src/lib/knowledge-graph.ts'),read('src/lib/resources.mjs'),read('scripts/lib/static-artifacts.mjs'),
]);
const [pkg,orchestrator,retrievalGenerator,rdfGenerator,descriptorGenerator,projectionContext,workspacePaths,pageAssets,graphCompiler,retrievalCorpus,contactCompiler,mediaGate,finalizer,headersCompiler,materializer,documentHead,baseLayout,indexPage,siteFooter,floatingActionDock,knowledgeGraph,resourceRegistry,staticRegistry]=files;
...
assert(pkg.scripts?.['clean:generated']==='node scripts/clean-generated-workspace.mjs','Generated workspace reset script drift');
...
assert(staticRegistry.trim()==="export {STATIC_ARTIFACTS,staticArtifactForRoute} from '../../src/lib/resources.mjs';",'Build tooling duplicates resource inventory');
