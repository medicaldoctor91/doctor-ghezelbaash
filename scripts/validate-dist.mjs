...
mustContain('aesthetic_medicine_knowledge_kermanshah_fa.json', 'mesogel');
mustContain('aesthetic_medicine_knowledge_kermanshah_fa.json', 'hydrogel-injection');
mustContain('aesthetic_medicine_knowledge_kermanshah_fa.json', 'blepharoplasty');
mustContain('aesthetic_medicine_knowledge_kermanshah_fa.json', 'rhinoplasty');
mustContain('aesthetic_medicine_knowledge_kermanshah_fa.json', 'hyaluronidase-filler-dissolving');
mustContain('aesthetic_medicine_knowledge_kermanshah_fa.json', 'knowledge-scope-only');
...
mustContain('services.json', 'nonOfficialConceptsAreKnowledgeScopeOnly');
mustContain('services.json', 'skin-booster');
mustContain('services.json', 'mesogel');
