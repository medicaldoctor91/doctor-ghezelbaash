...
mustContain('routes.json', 'ghezelbash.routes.astro.v1');
mustContain('routes.json', 'services-hub');
mustContain('routes.json', 'service');
mustContain('routes.json', 'knowledge-graph');
mustContain('seo-aeo-index.json', 'ghezelbash.seo_aeo_index.astro.v1');
...
mustContain('services.json', 'ghezelbash.service_architecture.astro.v2.entity_hardened');
...
mustContain('brand-kb.ghezelbaash.ai-public.json', 'ghezelbash.brand_kb.astro.v4.superset');
