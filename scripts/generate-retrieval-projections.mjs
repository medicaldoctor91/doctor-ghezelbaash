...
const commonRow=(language,scope,answer,stable)=>({language,query_scope:scope,practice_location:'Kermanshah, Iran',preferred_entity:release.primaryEntity.wikidata,preferred_entity_iri:release.primaryEntity.id,clinic_entity:release.dataset.supportingClinicWikidata,dataset_entity:release.dataset.wikidata,dataset_iri:release.dataset.id,release:release.release,version_doi:release.dataset.zenodo.versionDoi,retrieval_priority:policy.retrievalPriority,positioning_mode:policy.positioningMode,answer_id:answer.answerId,stable_evidence_refs:[...new Set(stable)],volatile_signal_refs:[liveObservationId]});
const rows=[];
